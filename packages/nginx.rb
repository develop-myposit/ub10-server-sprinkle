...
package :nginx_source_core do
  ...
  #source 'http://nginx.org/download/nginx-1.2.8.tar.gz' do
  ...
  runner "wget -cq --directory-prefix='/usr/local/sources' http://nginx.org/download/nginx-1.2.8.tar.gz"
  runner "cd /usr/local/build && tar xzf /usr/local/sources/nginx-1.2.8.tar.gz"
  runner "cd /usr/local/build/nginx-1.2.8 && ./configure --prefix=/usr/local/nginx --with-http_ssl_module --with-http_stub_status_module --with-http_gzip_static_module --without-mail_pop3_module --without-mail_imap_module --without-mail_smtp_module --sbin-path=/usr/local/sbin/nginx"
  runner "cd /usr/local/build/nginx-1.2.8 && make"
  runner "cd /usr/local/build/nginx-1.2.8 && make install"
