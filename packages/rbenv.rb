...
package :symlink_rubies do
  ...
  runner "ln -s /opt/ruby-1.9.3-p392 /home/#{DEPLOY_USER}/.rbenv/versions/1.9.3-p392"
#  runner "ln -s /opt/ruby-1.8.7-p352 /home/#{DEPLOY_USER}/.rbenv/versions/1.8.7-p352"
 ...
 #   @commands << "sudo -u #{DEPLOY_USER} -i /home/#{DEPLOY_USER}/.rbenv/bin/rbenv versions | grep 1.8.7-p352"
    @commands << "sudo -u #{DEPLOY_USER} -i /home/#{DEPLOY_USER}/.rbenv/bin/rbenv versions | grep 1.9.3-p392"
    has_symlink "/home/#{DEPLOY_USER}/.rbenv/versions/1.9.3-p392", '/opt/ruby-1.9.3-p392' 
...
package :set_default_ruby do
  ...
  push_text '1.9.3-p392', "/home/#{DEPLOY_USER}/.rbenv/global"
  
  verify do
    file_contains "/home/#{DEPLOY_USER}/.rbenv/global", '1.9.3-p392'
  end
end
...
package :add_rbenv_bundler do
  ...
  runner "/home/#{DEPLOY_USER}/.rbenv/versions/1.9.3-p392/bin/gem install bundler"
  runner "/home/#{DEPLOY_USER}/.rbenv/bin/rbenv rehash"
  
  verify do 
    @commands << "/home/#{DEPLOY_USER}/.rbenv/versions/1.9.3-p392/bin/gem list | grep bundler"
  end
end
